                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <!-- <div class="col-4 text-right">
                            <a href="{{ route('admin.expo.add') }}" class="btn btn-sm btn-primary">Create Course</a>
                        </div> -->
                    </div>
                </div>
                <div class="col-12">
...
<script type="text/javascript">
    ...
    var view    =   "{{ route('admin.expo.view', ['id' => '__id']) }}";
    var edit = "{{ route('admin.expo.edit',['id'=>'__id']) }}";
    var deletelink = "{{ route('admin.expo.delete',['id'=>'__id']) }}";
    ...
    "columns": [
        ...
        }},
        {
            "data": "action", "name": "action", "render": function (data, type, row) {
                ...
                action += "<a class='btn btn-danger' onclick='return confirm(\"Are you sure to delete this expo? \")' href='"+deletelink.replace("__id",row.id)+"'><i class='fa fa-trash'></i></a>";
                return action;
            }
        }
    ],
