                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('admin.plans.add') }}" class="btn btn-sm btn-primary">{{ __('New Plan') }}</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
...
<script type="text/javascript">
    ...
    var view    =   "{{ route('admin.plans.view', ['id' => '__id']) }}";
    var edit = "{{ route('admin.plans.edit',['id'=>'__id']) }}";
    var deletelink = "{{ route('admin.plans.delete',['id'=>'__id']) }}";
    ...
    "ajax": {
        "url": "{{ route('admin.plans.paginate') }}",
        "type": "post",
        "data": function (data) {
