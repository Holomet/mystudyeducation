            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Colleges</h3>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('admin.collages.add') }}" class="btn btn-sm btn-primary">Add College</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
...
<script type="text/javascript">
    ...
    var view    =   "{{ route('admin.collages.view', ['id' => '__id']) }}";
    var edit = "{{ route('admin.collages.edit',['id'=>'__id']) }}";
    var deletelink = "{{ route('admin.collages.delete',['id'=>'__id']) }}";
    ...
    "ajax": {
        "url": "{{ route('admin.collages.paginate') }}",
        "type": "post",
        "data": function (data) {
