                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('admin.collages.gallery.add',['id' => $id]) }}" class="btn btn-sm btn-primary">Create Gallery</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
...
<script type="text/javascript">
    ...
    var view    =   "{{ route('admin.collages.gallery.view', ['id' => '__id']) }}";
    var edit = "{{ route('admin.collages.gallery.edit',['id'=>'__id']) }}";
    var deletelink = "{{ route('admin.collages.gallery.delete',['id'=>'__id']) }}";
    ...
    "ajax": {
        "url": "{{ route('admin.collages.gallery.paginate') }}",
        "type": "post",
        "data": function (data) {
    ...
    "columns": [
        ...
        }},
        {
            "data": "action", "name": "action", "render": function (data, type, row) {
                ...
                action += "<a class='btn btn-danger' onclick='return confirm(\"Are you sure to delete this gallery? \")' href='"+deletelink.replace("__id",row.id)+"'><i class='fa fa-trash'></i></a>";
                return action;
            }
        }
    ],
