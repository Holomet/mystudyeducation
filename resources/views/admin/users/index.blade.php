                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('admin.users.add') }}" onclick="return addrole()" class="btn btn-sm btn-primary">Add User</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
...
<script type="text/javascript">
    ...
    var view    =   "{{ route('admin.users.view', ['id' => '__id']) }}";
    var edit = "{{ route('admin.users.edit',['id'=>'__id']) }}";
    var deletelink = "{{ route('admin.users.delete',['id'=>'__id']) }}";
    ...
    "columns": [
        ...
        { "data": "fullname", 'name': "fullname", "render": function(data, type, row){
        ...
        }},
        {
            "data": "action", "name": "action", "render": function (data, type, row) {
                ...
                action += "<a class='btn btn-danger' onclick='return confirm(\"Are you sure to delete this user? \")' href='"+deletelink.replace("__id",row.id)+"'><i class='fa fa-trash'></i></a>";
                return action;
            }
        }
    ],
