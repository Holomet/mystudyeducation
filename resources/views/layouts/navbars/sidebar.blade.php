<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('admin.dashboard') }}">
            <img src="{{ asset('admin/argon') }}/img/logo.jpg" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media align-items-center">
                        ...
                        <img alt="Image placeholder" src="{{ asset('admin/argon') }}/img/theme/team-1-800x800.jpg">
                        </span>
                    </div>
                </a>
                ...
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="{{ route('admin.dashboard') }}">
                            <img src="{{ asset('admin/argon') }}/img/logo.jpg">
                        </a>
                    </div>
